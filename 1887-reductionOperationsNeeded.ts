...
// ------------ 1887 - REDUCTION OPERATIONS NEEDED ------------ //
...
// If the current number is smaller than the previous number, add the difference to the answer.
// Return the answer.
...
//run ts-node 1887-reductionOperationsNeeded.ts