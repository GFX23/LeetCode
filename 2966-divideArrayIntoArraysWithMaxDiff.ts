...
// ----- 2966 - Divide Array into Arrays With Max Diff -------- //
...
console.log(divideArray([1,3,3,2,5,3], 3))
console.log(divideArray([1,3,3,4,7,10], 2))

// ----------------------- CLI COMMAND ------------------------ //

//run ts-node 2966-divideArrayIntoArraysWithMaxDiff.ts